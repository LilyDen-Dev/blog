					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							{{ Form::select('category_id',
							 $categories,
							  $post->getCategoryID(),
							   ['class' => 'form-control select2']) }} {{--для выбора категорий. из ларавель коллектив drop-doun--}}
						</div>
						<div class="form-group">
							<label>Теги</label>
							{{ Form::select('tags[]',
						...
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right" id="datepicker" name="date" value="08/29/2017">
							</div>
							<!-- /.input group -->
						</div>
